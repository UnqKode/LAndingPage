...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-black via-black to-blue-950 text-white px-6 py-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
        ...
        {/* Features */}
        <div className="md:col-span-2 rounded-xl p-6 bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700">
        ...
        >
          ...
          <div className="border-t border-gray-700 pt-4">
            ...
            >
              <button className="px-5 py-2 bg-blue-600 hover:bg-blue-700 rounded-md text-white font-medium transition">
                Get API Key
              </button>
            </a>
          </div>
